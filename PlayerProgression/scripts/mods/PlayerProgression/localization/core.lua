return {
	...
	player_progression_button = {
		en = "Player Progression",
		ru = "Прогресс игрока",
	},
	keybind_toggle_stats = {
		en = "Toggle Stats Display",
		ru = "Переключить отображение статистики",
	},
	player_progression_title = {
		en = "PLAYER PROGRESSION",
		ru = "ПРОГРЕСС ИГРОКА",
	},
	tactical_overlay_player_progression = {
		en = "Player Progression",
		ru = "Прогресс игрока",
	},
	...
	player_progression_no_selected_items = {
	...
	playstation_controller_button_description = {
		en = "Select the button on PlayStation controller to toggle stats display.",
		ru = "Выберите кнопку на контроллере PlayStation для переключения отображения статистики.",
	},
	i18n_xbox_section = {
		en = "Xbox",
		ru = "Xbox",
	...
	xbox_controller_button_description = {
		en = "Select the button on Xbox controller to toggle stats display.",
