...
TabRecords.create_layout = function(safe_read_stat, localize, format_number)
    ...
    table.insert(layout, {
        ...
        text_key = "stats_max_headshots",
        stat_name = "max_head_shot_in_a_row",
        description_key = "loc_achievement_consecutive_headshots_description",
    })
    table.insert(layout, {
        widget_type = "stat_line_with_description",
        ...
        text_key = "stats_max_kills_60s",
        stat_name = "max_kills_last_60_sec",
        description_key = "loc_achievement_fast_enemies_x_description",
    })
    table.insert(layout, {
        widget_type = "stat_line_with_description",
        ...
        text_key = "stats_max_headshots_10s",
        stat_name = "max_head_shot_kills_last_10_sec",
        description_key = "loc_achievement_fast_headshot_x_description",
    })
    table.insert(layout, {
        widget_type = "stat_line_with_description",
        ...
        text_key = "stats_max_focus_fire_kills",
        stat_name = "kills_during_max_focus_fire_stack",
        description_key = "loc_achievement_veteran_enemies_killed_with_max_focus_fire_description",
    })
    table.insert(layout, {
        widget_type = "stat_line_with_description",
        ...
        text_key = "stats_max_elite_special_volley",
        stat_name = "max_multiple_elite_or_special_kills_during_volley_fire_heresy",
        description_key = "loc_achievement_veteran_2_hard_1_description",
    })
    table.insert(layout, {
        widget_type = "stat_line_with_description",
        ...
        text_key = "stats_max_smite_elite_special",
        stat_name = "max_elite_or_special_kills_with_smite_last_12_sec",
        description_key = "loc_achievement_psyker_2_elite_or_special_kills_with_smite_last_10_sec_description",
    })
    table.insert(layout, {
        widget_type = "stat_line_with_description",
        ...
        text_key = "stats_max_smite_boss_damage",
        stat_name = "max_smite_damage_done_to_boss",
        description_key = "loc_achievement_psyker_2_kill_boss_solo_with_smite_description",
    })
    ...
    if fastest_boss > 0 and fastest_boss < 18000 then
        table.insert(layout, {
            ...
            text_key = "stats_fastest_boss_kill",
            stat_name = "fastest_boss_kill",
            description_key = "loc_achievement_boss_fast_x_description",
        })
    end
    ...
    table.insert(layout, {
        ...
        text_key = "stats_max_dodges_record",
        stat_name = "max_dodges_in_a_row",
        description_key = "loc_achievement_consecutive_dodge_x_description",
    })
    table.insert(layout, {
        widget_type = "stat_line_with_description",
        ...
        text_key = "stats_max_damage_blocked_20s",
        stat_name = "max_damage_blocked_last_20_sec",
        description_key = "loc_achievement_fast_blocks_x_description",
    })
    table.insert(layout, {
        widget_type = "stat_line_with_description",
        ...
        text_key = "stats_team_poxburster_avoided",
        stat_name = "team_poxburster_damage_avoided",
        description_key = "loc_achievement_team_poxburster_damage_avoided_description",
    })
    table.insert(layout, {
        widget_type = "stat_line_with_description",
        ...
        text_key = "stats_grenadier_before_attack",
        stat_name = "grenadier_killed_before_attack_occurred",
        description_key = "loc_achievement_grenadier_killed_before_attack_occurred_description",
    })
    table.insert(layout, {
        widget_type = "stat_line_with_description",
        ...
        text_key = "stats_flamer_before_attack",
        stat_name = "flamer_killed_before_attack_occurred",
        description_key = "loc_achievement_flamer_killed_before_attack_occurred_description",
    })
    table.insert(layout, {
        widget_type = "stat_line_with_description",
        ...
        text_key = "stats_bullwark_backstab_damage",
        stat_name = "bulwark_backstab_damage_inflicted",
        description_key = "loc_achievement_bulwark_backstab_damage_inflicted_description",
    })
    table.insert(layout, {
        widget_type = "stat_line_with_description",
        ...
        text_key = "stats_team_chaos_spawn_clean",
        stat_name = "team_chaos_spawned_killed_no_players_grabbed",
        description_key = "loc_achievement_team_chaos_spawned_killed_no_players_grabbed_description",
    })
    table.insert(layout, {
        widget_type = "stat_line_with_description",
        ...
        text_key = "stats_team_beast_clean",
        stat_name = "team_chaos_beast_of_nurgle_slain_no_corruption",
        description_key = "loc_achievement_team_chaos_beast_of_nurgle_slain_no_corruption_description",
    })
    table.insert(layout, {
        widget_type = "stat_line_with_description",
        ...
        text_key = "stats_max_different_players_rescued",
        stat_name = "max_different_players_rescued",
        description_key = "loc_achievement_revive_all_description",
    })
    ...
    table.insert(layout, {
        ...
        text_key = "stats_lowest_damage_taken",
        stat_name = "lowest_damage_taken_on_win",
        description_key = "loc_achievement_mission_no_damage_description",
    })
    ...
    table.insert(layout, {
        ...
        text_key = "stats_vet_max_weakspot_hits_volley",
        stat_name = "max_weakspot_hit_during_volley_fire_alternate_fire",
        description_key = "loc_achievement_veteran_2_weakspot_hits_during_volley_fire_alternate_fire_description",
    })
    table.insert(layout, {
        widget_type = "stat_line_with_description",
        ...
        text_key = "stats_vet_max_elite_weakspot_volley",
        stat_name = "max_elite_weakspot_kill_during_volley_fire_alternate_fire",
        description_key = "loc_achievement_veteran_2_elite_weakspot_kills_during_volley_fire_alternate_fire_description",
    })
    table.insert(layout, {
        widget_type = "stat_line_with_description",
        ...
        text_key = "stats_vet_max_last_round_kills",
        stat_name = "max_veteran_2_kills_with_last_round_in_mag",
        description_key = "loc_achievement_veteran_2_kills_with_last_round_in_mag_description",
    })
    table.insert(layout, {
        widget_type = "stat_line_with_description",
        ...
        text_key = "stats_vet_min_melee_damage_taken",
        stat_name = "veteran_min_melee_damage_taken",
        description_key = "loc_achievement_veteran_2_no_melee_damage_taken_description",
    })
    ...
    table.insert(layout, {
        ...
        text_key = "stats_zealot_stagger_sniper_distance",
        stat_name = "max_zealot_2_stagger_sniper_with_grenade_distance",
        description_key = "loc_achievement_zealot_2_stagger_sniper_with_grenade_distance_description",
    })
    table.insert(layout, {
        widget_type = "stat_line_with_description",
        ...
        text_key = "stats_zealot_kills_shocked_15s",
        stat_name = "max_zealot_2_kills_of_shocked_enemies_last_15",
        description_key = "loc_achievement_zealot_2_kills_of_shocked_enemies_last_15_description",
    })
    table.insert(layout, {
        widget_type = "stat_line_with_description",
        ...
        text_key = "stats_zealot_heal_leech_resist",
        stat_name = "max_zealot_2_health_healed_with_leech_during_resist_death",
        description_key = "loc_achievement_zealot_2_healed_up_after_resisting_death_description",
    })
    ...
    table.insert(layout, {
        ...
        text_key = "stats_psyker_edge_kills_2s",
        stat_name = "max_psyker_2_edge_kills_last_2_sec",
        description_key = "loc_achievement_psyker_2_edge_kills_last_2_sec_description",
    })
    table.insert(layout, {
        widget_type = "stat_line_with_description",
        ...
        text_key = "stats_psyker_time_max_souls",
        stat_name = "max_psyker_2_time_at_max_souls",
        description_key = "loc_achievement_psyker_2_stay_at_max_souls_for_duration_description",
    })
    table.insert(layout, {
        widget_type = "stat_line_with_description",
        ...
        text_key = "stats_psyker_kills_overcharge",
        stat_name = "max_psyker_kills_during_overcharge_stance",
        description_key = "loc_achievement_psyker_kills_during_overcharge_stance_description",
    })
    ...
    table.insert(layout, {
        ...
        text_key = "stats_ogryn_lunge_hits",
        stat_name = "max_ogryn_2_lunge_number_of_enemies_hit",
        description_key = "loc_achievement_ogryn_2_bull_rushed_100_enemies_description",
    })
    table.insert(layout, {
        widget_type = "stat_line_with_description",
        ...
        text_key = "stats_ogryn_lunge_distance",
        stat_name = "max_ogryn_2_lunge_distance_last_x_seconds",
        description_key = "loc_achievement_ogryn_2_bull_rushed_70_within_25_seconds_description",
    })
    table.insert(layout, {
        widget_type = "stat_line_with_description",
        ...
        text_key = "stats_ogryn_bullrushed",
        stat_name = "max_ogryns_bullrushed",
        description_key = "loc_achievement_ogryn_2_bull_rushed_4_ogryns_description",
    })
