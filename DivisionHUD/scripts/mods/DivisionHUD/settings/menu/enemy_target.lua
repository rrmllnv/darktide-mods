...
return {
	...
	sub_widgets = {
			...
			sub_widgets = {
				{
					...
					default_value = d("enemy_target_show_on_hover", true),
				},
				{
		...
		{
			setting_id = "enemy_target_show_debuffs",
			type = "checkbox",
			title = "enemy_target_show_debuffs",
			tooltip_text = "enemy_target_show_debuffs_description",
			default_value = d("enemy_target_show_debuffs", true),
		},
		{
			...
			sub_widgets = {
				...
				},
				{
					...
					default_value = d("enemy_target_show_elite", true),
				},
				{
					...
					default_value = d("enemy_target_show_special", true),
				},
			},
		},
	},
