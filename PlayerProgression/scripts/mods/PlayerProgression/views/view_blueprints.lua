...
local constants = get_mod("PlayerProgression"):io_dofile("PlayerProgression/scripts/mods/PlayerProgression/views/view_constants")
		...
		if hotspot and hotspot.on_pressed then
			...
			if not is_empty then
				...
				if content.element_id and content.element_id ~= "" then
					...
					mod:set("playerprogression_checkbox_states", checkbox_states)
