...
local killsboard_view_settings = {
    ...
    killsboard_size = {1020, 900},
    killsboard_row_height = 16, -- 20
    killsboard_row_header_height = 22, -- 30
    killsboard_column_width = 85, -- ширина для K или D столбца
    killsboard_column_player_width = 180, -- ширина для пары K+D (2 столбца) - используется для позиционирования
