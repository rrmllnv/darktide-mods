...
function M.append_passes(passes, settings, templates)
	...
	passes[#passes + 1] = templates.text_pass(settings, "relation_status", "relation_status", 15, { settings.relation_status_x, settings.relation_status_y, 7 }, { settings.relation_status_width, settings.relation_status_height }, settings.color_text_default, "right")
end
