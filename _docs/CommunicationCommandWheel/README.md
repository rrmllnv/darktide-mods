...
- **Колёсико переключает страницы** (чекбокс): при открытом колесе прокрутка в любом месте; сначала ось `scroll_axis` у HUD-сервиса **View**, затем **Ingame** `wield_scroll_*`, затем сырая ось `wheel` мыши.
