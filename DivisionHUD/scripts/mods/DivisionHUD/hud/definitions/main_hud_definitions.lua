...
local _division_toughness_health = DivisionHUDToughnessHealthDefs.build(BAR_WIDTH, TOUGHNESS_BAR_HEIGHT, HEALTH_BAR_HEIGHT, BAR_LABEL_W, BAR_STACK_GAP, sc)
...
local _division_stamina_dodge = DivisionHUDStaminaDodgeDefs.build(MAIN_ROW_HEIGHT, BAR_FILL_WIDTH, sc)
...
return {
	...
	ALERT_PALETTE_TACTICAL_ADVISOR = _division_alerts.ALERT_PALETTE_TACTICAL_ADVISOR,
	ALERT_PALETTE_THREAT_ADVISOR = _division_alerts.ALERT_PALETTE_THREAT_ADVISOR,
	...
	ABILITY_ICON_ACTIVE_COLORS = _division_ability_icon.ABILITY_ICON_ACTIVE_COLORS,
	ABILITY_ICON_COOLDOWN_COLORS = _division_ability_icon.ABILITY_ICON_COOLDOWN_COLORS,
}
