...
Да (голос есть)
Нет (голос есть)
Пожалуйста (голос есть)
Извини
Нужна помощь (calling_for_help ) (голос есть)
Возьми это (голос есть)
Мне это нужно (голос есть)
Вниамние, Демонхост (голос есть)
Почти на месте (голос есть)
Отстал от отряда (голос есть)

страница 2

Следую за тобой (голос есть)
Следуй за мной
Прикрой меня
Иду к тебе
Жду тебя
Не отставай
Быстрее
Wait (Ждите)  (голос есть)
Назад

## Дополнительные варианты команд
...
### Специфичные команды для Darktide
Демонхост
Поксбурстер
Трейпер
Хаунд
...
- **MULTIPAGE_WHEEL.md** - Руководство по созданию многостраничного колеса команд
- **WHEEL_DESIGN_VARIANTS.md** - Варианты дизайна многостраничного меню
