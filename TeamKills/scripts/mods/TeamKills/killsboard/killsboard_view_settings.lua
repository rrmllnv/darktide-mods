...
local killsboard_view_settings = {
    ...
    killsboard_size = {1300, 900},
    killsboard_row_height = 16, -- 20
    killsboard_row_header_height = 22, -- 30
    killsboard_column_width = 110, -- ширина для K или D столбца
    killsboard_column_player_width = 240, -- ширина для пары K+D (2 столбца) - используется для позиционирования
    killsboard_column_player_bg_width = 280, -- ширина фона столбца игрока
    killsboard_column_header_width = 210,
